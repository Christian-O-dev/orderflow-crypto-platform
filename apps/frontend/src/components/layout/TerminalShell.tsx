...
export function TerminalShell({ children }: TerminalShellProps) {
  return (
    <main className="min-h-dvh overflow-auto bg-[#070A0F] text-[#E5E7EB] lg:h-dvh lg:overflow-hidden">
      ...
      <section className="relative flex min-h-dvh w-full flex-col px-2 py-2 sm:px-3 lg:h-full lg:min-h-0 lg:px-4">
        {children}
      </section>
    </main>
  );
